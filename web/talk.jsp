...
if(userDetails!=null){
    ...
    HashMap tUserDetails=(HashMap)dbc.getPeoplebyEmailId(temail);
  ...
  <body data-spy="scroll" data-target="#my-navbar">
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			...
			<a class="navbar-brand" href="profile.html">Chat-Web</a>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="form-group">
						...
						<label for="name" class="control-label">Email:<font color="grey"> <%=temail%></font></label><br>
						<label for="dob" class="control-label">Date of Birth: <font color="grey"><%=tUserDetails.get("dob")%></font></label><br>
						<label for="address" class="control-label">Address: <font color="grey"><%=tUserDetails.get("area")%></font></label><br>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="navbar navbar-inverse navbar-fixed-bottom">
		<div class="container">
			<div class="navbar-text pull-left">
				<p>Design and Develop by zeeshan</p>
			</div>
		</div>
	</div>
